...
try {
    ...
    // 修改 sys_position 表，添加 dept_id 字段
    echo "修改 sys_position 表...\n";
    $stmt = $pdo->query("ALTER TABLE sys_position ADD COLUMN dept_id INT(10) UNSIGNED NOT NULL DEFAULT 0 AFTER position_name");
    echo "添加 dept_id 字段成功！\n";
